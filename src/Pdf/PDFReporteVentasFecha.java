...
final class PDFReporteVentasFecha {
 ...
 PDFReporteVentasFecha(String titulo, String fechaDel, String fechaAl) {
  Colocar_Destino();
  strRotuloPDF = titulo;
...
private void agregarTabla(Paragraph parrafo,String fechaDel,String fechaAl) {
 float anchosFilas[] = {1f,1f,0.7f,1f,1f};
     ...
     PdfPCell cell = new PdfPCell(new Paragraph("VENTAS REALIZADAS ENTRE: '" + fechaDel + " y " + fechaAl + "'"));
     cell.setColspan(8);
	...
	cell.setHorizontalAlignment(Element.ALIGN_CENTER);
      ...
      strConsultaSQL = "SELECT idVentas,dniCliente,Fecha,Hora,Total FROM ventas WHERE Fecha BETWEEN '"+ fechaDel + "' AND'" + fechaAl +"'";
