...
public nuevoInsumo(java.awt.Frame parent, boolean modal) {
 super(parent, modal);
 initComponents();
}
    ...
    private void initComponents() {
        ...
        txtNumUsos = new javax.swing.JTextField();
        ...
        jLabel18.setText("Numero de usos por cant");

        txtNumUsos.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtNumUsos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtNumUsosKeyTyped(evt);
            }
        });
    ...
    private void txtNumUsosKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumUsosKeyTyped
    
    }//GEN-LAST:event_txtNumUsosKeyTyped
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nuevoInsumo dialog = new nuevoInsumo(new javax.swing.JFrame(), true);
