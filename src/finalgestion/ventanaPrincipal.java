...
public class ventanaPrincipal extends VentanaConFondo  implements Runnable{
 ...
 public static int listCliente=0,listEmpleados=0,listGrupoFamiliar=0,
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEmp, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, -1, -1));
        ...
        getContentPane().add(lblEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 440, -1, 30));
        ...
        getContentPane().add(lblDniEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 450, -1, -1));

        lblHora.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblHora.setForeground(new java.awt.Color(-4144960,true));
        lblHora.setText("00:00:00");
        getContentPane().add(lblHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 470, -1, -1));
        ...
        getContentPane().add(lblEmp1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, -1, -1));
        ...
        getContentPane().add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 470, -1, -1));
        ...
        setSize(new java.awt.Dimension(978, 566));
