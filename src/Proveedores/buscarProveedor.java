...
public class buscarProveedor extends javax.swing.JDialog {
 ...
 private JTextField txtProveedor;
    ...
    public buscarProveedor(java.awt.Frame parent, boolean modal, JTextField txtProveedor) {
     super(parent, modal);
     initComponents();
     this.txtProveedor = txtProveedor;
     String[] titulos ={"ID", "Razón Social"};
     tabla = new DefaultTableModel(null,titulos);
     tablaProveedores.setModel(tabla);
     tabla.setRowCount(0);
     proveedor.cargarProveedores(4);
    }
    ...
    private void aceptarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aceptarButtonMouseClicked
        ...
        this.txtProveedor.setText(tablaProveedores.getValueAt(fila, 0).toString()+"-"+tablaProveedores.getValueAt(fila, 1).toString());
        dispose();
...
//}
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscarProveedor dialog = new buscarProveedor(new javax.swing.JFrame(), true,new JTextField());
