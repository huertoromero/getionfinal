...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2019 a las 14:32:53
...
INSERT INTO `clientes` (`dniCliente`, `Apellido`, `Nombre`, `Telefono`, `Email`, `FechaDeAlta`, `FechaDeBaja`, `Estado`, `idDomicilio`) VALUES
(11111111, 'Apaza', 'Silvana', 3814637256, 'silva_d@gmail.com', '2015-09-01', '0000-00-00', 1, NULL);
...
INSERT INTO `domicilio` (`idDomicilio`, `calle`, `numero`, `descripcion`, `idLocalidad`) VALUES
(1, 'Rivadavia', 1050, NULL, 1);
...
INSERT INTO `empleados` (`dniEmpleado`, `nombre`, `apellido`, `fechaNacimiento`, `cuil`, `fechadeingreso`, `telefono`, `Mail`, `direccion`, `estado`, `fechaBaja`, `idCategoria`, `idDomicilio`) VALUES
(32412262, 'francisco', 'palavecino', '1986-06-15', 20324122622, '2019-05-08', 3814535153, 'palavecinofran@gmail.com', 'rivadavia 546', 1, NULL, 1, 1),
(38742005, 'julieta', 'aro', '1995-08-17', 27387420059, '2019-05-08', 3815333706, 'julietaaaro@gmail.com', 'monteagudo 747', 1, NULL, 1, 1),
(39479341, 'huerto', 'romero', '1995-07-05', 27394793412, '2019-05-05', 3814252612, 'huertoro@gmail.com', 'barrio 1', 1, NULL, 3, 1),
(39479342, 'huerto', 'romero', '1995-07-05', 27394793421, '2019-05-08', 2353747, 'huertoro@gmail.com', 'jujuy74', 0, '2019-07-29', 3, 1),
(39889919, 'virginia', 'arroyo', '1996-01-17', 27398899194, '2019-05-08', 3865623116, 'vickyarroyo@gmail.com', 'san juan 730', 1, NULL, 2, 1);
...
(1, 'San Miguel de Tucuman', 4000, 1);
...
INSERT INTO `proveedor` (`idProveedor`, `RazonSocial`, `Telefono`, `Email`, `fechadeAlta`, `fechadeBaja`, `estado`, `direccion`, `provincia`, `idDomicilio`) VALUES
(1, 'distribuidora avon', 3865111111, 'avon@avon', '2015-09-05', NULL, 1, 'avon 200', 'tucuman', NULL),
(2, 'distribuidora nivea', 3865222222, 'nivea@nivea', '2015-09-05', NULL, 1, 'nivea 300', 'tucuman', NULL),
(3, 'distribuidora head and shouders', 3865333333, 'head@shouders', '2015-09-05', NULL, 1, 'head and shouders 300', 'tucuman', NULL);
...
ALTER TABLE `clientes`
  ...
  ADD KEY `fk_Clientes_Domicilio` (`idDomicilio`);
...
ALTER TABLE `insumo`
  ...
  ADD KEY `fk_Insumo_Proveedor1_idx` (`proveedor_id`);
...
ALTER TABLE `proveedor`
  ...
  ADD KEY `fk_Proveedor_Domicilio` (`idDomicilio`);
...
--
ALTER TABLE `insumo`
  ADD CONSTRAINT `fk_Insumo_Proveedor1` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedor` (`idProveedor`);
